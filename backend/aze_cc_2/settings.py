"""
Django settings for aze_cc_2 project.
...
WSGI_APPLICATION = 'aze_cc_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aze_cc_2 API",
    "DESCRIPTION": "API documentation for aze_cc_2 App",
    "VERSION": "v1",
}
